...
[server/results/routes/list.ts](../../server/results/routes/list.ts)
...
**Implementation Handler:**
[server/results/routes/submit.ts](../../server/results/routes/submit.ts)
...
**Implementation Handler:**
[server/results/routes/get.ts](../../server/results/routes/get.ts)
